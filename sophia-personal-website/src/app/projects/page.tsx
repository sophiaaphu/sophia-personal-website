    ...
    <main className="flex flex-col py-12 gap-4">
      ...
      <div className="flex flex-col gap-4 pb-8">
        <div className="mt-2 flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex gap-4 md:gap-8 bg-[#DAB6BC] sm:px-4 md:px-8 rounded-lg lg:w-2/3 shadow-md pt-4 md:pt-8 group overflow-hidden justify-center">
        ...
        <div className="mt-2 flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex gap-4 md:gap-8 bg-[#FEB1BE] sm:px-4 md:px-8 rounded-lg lg:w-2/3 shadow-md pt-4 md:pt-8 group overflow-hidden justify-center">
            <div className="flex -ml-4 sm:-ml-0 items-end transform transition-transform duration-300 group-hover:scale-105">
              <Image
        ...
        <div className="mt-4 flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex gap-4 md:gap-8 bg-[#AAEAED] sm:pl-4 md:pl-8 rounded-lg lg:w-2/3 shadow-md pt-4 md:pt-8 group overflow-hidden justify-center">
            <div className="flex -ml-4 sm:-ml-0 items-end transform transition-transform duration-300 group-hover:scale-105">
              <Image
                src="/swipetern-1.png"
                alt="swipetern 1"
        ...
        <div className="mt-4 flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex gap-4 md:gap-8 bg-[#C0C0C0] sm:pl-4 md:pl-8 rounded-lg lg:w-2/3 shadow-md pt-4 md:pt-8 group overflow-hidden justify-center">
            <div className="flex -ml-4 sm:-ml-0 items-end transform transition-transform duration-300 group-hover:scale-105">
              <Image
                src="/split-1.png"
                alt="split 1"
